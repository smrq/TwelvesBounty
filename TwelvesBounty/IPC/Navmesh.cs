...
namespace TwelvesBounty.IPC {
	public class Navmesh {
		...
		private readonly ICallGateSubscriber<Vector3, float, Vector3?> queryMeshPointOnFloor;
		...
		public Navmesh() {
			...
			queryMeshPointOnFloor = Plugin.PluginInterface.GetIpcSubscriber<Vector3, float, Vector3?>("vnavmesh.Query.Mesh.PointOnFloor");
		...
		public Vector3? PointOnFloor(Vector3 position, float halfExtentXZ) => queryMeshPointOnFloor.InvokeFunc(position, halfExtentXZ);
